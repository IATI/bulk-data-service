...
from bulk_data_service.data_converters import convert_reporting_org_to_reporting_org_dto
...
def generate_reporting_org_created_updated_payload(reporting_org_db_record: dict, update_type: str) -> dict:
    return {
        ...
        "message_date": get_current_timestamp_as_str(),
        "reporting_org": convert_reporting_org_to_reporting_org_dto(reporting_org_db_record),
    }
