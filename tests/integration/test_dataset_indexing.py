...
#     organisation = organisations_in_bds[uuid.UUID("ea055d99-f7e9-456f-9f99-963e95493c1b")]

#     assert organisation["name"] in minimal_index["organisations"]

#     organisation_item = minimal_index["organisations"]["test_foundation_a"]

#     for field in get_minimal_index_dataset_fields(context):
#         assert organisation_item[field] == str(organisation[field])

#     # -2 because of the two autogenerated fields
#     assert len(organisation_item.keys()) - 2 == len(get_minimal_index_dataset_fields(context))
